...
public class Bot extends TelegramLongPollingBot
{
	...
	public Bot(Connection connection) throws FileNotFoundException
	{
		...
		base_paginator = new KeyboardPaginator()
				...
				.then(SHOP_BUTTON, STATUS_BUTTON, DUELS_BUTTON)
				.last(PAY_BUTTON, INFO_BUTTON, RENAME_BUTTON, SHOPPLACE_BUTTON, CHECK_BUTTON, SELLFISH_BUTTON, RECIPES_BUTTON, DONATE_BUTTON, STATS_BUTTON);
