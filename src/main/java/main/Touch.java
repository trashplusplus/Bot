...
public class Touch {
    ...
    private void infoInit(Player player, String anotherPlayer){
        ...
        newFlavourTxt("Скейтборд", "На скейте можно сделать флип и получить булавку");
        newFlavourTxt("Гитара Fender", "Сыграть *Rape me* или *My Own Summer*...");
        newFlavourTxt("Связь", "Ало? Не чуе баба");
        newFlavourTxt("Антенна", "•−− ••• • −−   ••• •−•• ••− −−−− •− − −••−   −•• • −• −••−   −••• •− −••• −−− −−−• • −•− −−••−−");
        newFlavourTxt("Редкое кольцо", "Вы держите в руках редк... а нет, оно уже упало в водосток. Эх(");
        newFlavourTxt("Микросхема", "Схема имеет транзистор, динамик, катушку индуктивности и резистор");
        newFlavourTxt("Розовый телефон", "*Гаф-гаф-гаф, Ay-ay-ay i'm your little butterfly*");
        newFlavourTxt("Дека", "Подходит для создания *Гитары* и *Скейтборда*");
        newFlavourTxt("Аккумулятор", "Используется в крафте *Розового телефона*");
